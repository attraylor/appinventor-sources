 ...
 */
public final class MockGraph extends MockVisibleComponent {
  ...
  private final Image largeImage = new Image(images.graph());
  ...
  // being dragged from the palette
  @Override
